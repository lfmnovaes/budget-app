...
class GroupInvestmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create group_investment" do
    assert_difference("GroupInvestment.count") do
      post group_investments_url, params: { group_investment: { group_id: @group_investment.group_id, investment_id: @group_investment.investment_id } }
    end
  ...
  test "should update group_investment" do
    patch group_investment_url(@group_investment), params: { group_investment: { group_id: @group_investment.group_id, investment_id: @group_investment.investment_id } }
