  ...
  def create
    ...
    respond_to do |format|
      if @group_investment.save
        format.html { redirect_to group_investment_url(@group_investment), notice: "Group investment was successfully created." }
  ...
  def update
    respond_to do |format|
      if @group_investment.update(group_investment_params)
        format.html { redirect_to group_investment_url(@group_investment), notice: "Group investment was successfully updated." }
